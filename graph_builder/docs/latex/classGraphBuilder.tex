...
\begin{center}
\leavevmode
\includegraphics[width=192pt]{classGraphBuilder__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Gets a reference to the underlying \doxylink{classTrafficGraph}{Traffic\+Graph} object. \end{DoxyCompactList}\end{DoxyCompactItemize}
