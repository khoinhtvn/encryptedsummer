...
std\+::weak\+\_\+ptr$<$ \mbox{\hyperlink{classGraphEdge}{Graph\+Edge}} $>$ \mbox{\hyperlink{classTrafficGraph_a3280806b85e7a6a1b534551c5d1340d1}{add\+\_\+edge}} (const std\+::string \&src, const std\+::string \&tgt, const std\+::string \&rel, const std\+::unordered\+\_\+map$<$ std\+::string, std\+::string $>$ \&attrs=\{\})
...
\Hypertarget{classTrafficGraph_a3280806b85e7a6a1b534551c5d1340d1}\index{TrafficGraph@{TrafficGraph}!add\_edge@{add\_edge}}
\index{add\_edge@{add\_edge}!TrafficGraph@{TrafficGraph}}
\doxysubsubsection{\texorpdfstring{add\_edge()}{add\_edge()}}
{\footnotesize\ttfamily \label{classTrafficGraph_a3280806b85e7a6a1b534551c5d1340d1} 
std\+::weak\+\_\+ptr$<$ \mbox{\hyperlink{classGraphEdge}{Graph\+Edge}} $>$ Traffic\+Graph\+::add\+\_\+edge (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{src}{, }\item[{const std\+::string \&}]{tgt}{, }\item[{const std\+::string \&}]{rel}{, }\item[{const std\+::unordered\+\_\+map$<$ std\+::string, std\+::string $>$ \&}]{attrs}{ = {\ttfamily \{\}}}\end{DoxyParamCaption})}
